    ...
    <main className="">
      <div className="z-10 max-w-lg w-full items-center justify-between font-mono text-sm lg:flex">
        ...
        <Narration
          ...
          imagePrompt={`You are an experienced Australian field reporter describing images to the blind. You describe a scene provided by the user in vivid detail. 
          Describe the scene as if you were painting a picture with words. Start your description with: "A field footage of" then use keywords and simple phrases separated by commas.
