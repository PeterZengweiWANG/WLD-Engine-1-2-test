...
export default function KnowledgeGraph({
  ...
  const [concept, setConcept] = useState<string>(
    "The project focuses on transforming wildfire-affected areas in Healesville, Victoria, into sustainable opportunities. Beneficial reuse of burnt land is achieved through mushroom cultivation and biochar production, promoting agricultural practices, and recycling vegetation. Aboriginal cool-burning techniques and urban relocation minimize wildfire risks while creating suitable land for cultivation and attracting tourism. Innovative hydraulic engineering and landscape design are implemented through anti-fire berm structures, integrating water reservoirs, fire observation towers, fast reaction stations, hot springs, spas, and wildlife sanctuaries. These combined efforts enhance safety, promote sustainable agriculture, boost tourism, and protect wildlife while preserving Aboriginal heritage."
  );
